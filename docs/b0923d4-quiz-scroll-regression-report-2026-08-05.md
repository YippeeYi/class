...
历史版本是一套多入口静态应用，核心能力包括邀请门禁、普通/书面记录、人物、名言、搜索、答题、时间线统计、补充资料、蹭饭图、背景主题与管理员工具。正文使用自定义标记语言，历史解析器可识别 `del`、`under`、`red`、`hide`、`sup`、`sub`、`center`、`right`、人物/名言/记录/资料引用、注释、插图、分数、箭头和表格。

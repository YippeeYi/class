...
<html lang="zh-CN">
  ...
  <body>
    ...
    <script type="module">
      ...
      const formulaNesting = '纯[[latex:\\frac{a}{b}]]；人物[[person:p01|[[latex:\\frac{a}{b}]]]]；复合[[red:[[person:p01|[[under:[[latex:\\frac{a}{b}]]]]]]]]；反向[[latex:[[red:[[person:p01|\\frac{a}{b}]]]]]]；记录[[record:r1|[[latex:E=mc^{2}]]]]；资料[[material:m1|[[latex:x_{i}]]]]；注释[[anno:反应条件|[[latex:\\xrightarrow[\\text{催化剂}]{\\text{加热}}]]]]；化学[[latex:\\ce{A ->[\\text{加热}][\\text{催化剂}] B}]]；块级[[latex-block:\\begin{matrix}a&b\\\\c&d\\end{matrix}]][[red:[[person:p01|[[latex-block:\\begin{matrix}a&b\\\\c&d\\end{matrix}]]]]]][[latex-block:[[red:\\begin{matrix}a&b\\\\c&d\\end{matrix}]]]]'
      const formulaInternal = '文字[[latex:\\text{中文}+\\text{English}]]；分式[[latex:\\frac{\\text{中文}+[[person:p01|\\text{张三}]]}{\\text{denominator}+[[under:\\text{下划线}]]}]]；方程[[latex-block:\\begin{aligned}E&=mc^2+[[record:r1|\\text{记录}]]\\\\F&=ma+[[material:m1|\\text{资料}]]\\end{aligned}]]；化学[[latex:\\ce{A + [[red:B]] -> C}]]；注释[[latex:x+\\text{[[anno:公式注释|提示]]}]]；组合[[latex:a+[[red:[[under:[[del:[[person:p01|x^2]]]]]]]]]]；上标[[latex:x^{[[person:p01|i]]}]]'
          ...
          e(BackgroundRoot, null,
            e(React.Fragment, null,
              ...
              e(TooltipProvider, { delay: 0 },
                ...
                e(Case, { id: 'formula-nesting', width: '52rem', content: formulaNesting }),
                e(Case, { id: 'formula-internal', width: '52rem', content: formulaInternal }),
                e(Case, { id: 'formula-security', width: '52rem', content: '[[latex:x+[[person:p01|\\text{<img src=x onerror=alert(1)>}]]]] [[latex:\\href{javascript:alert(1)}{bad}]]' }),

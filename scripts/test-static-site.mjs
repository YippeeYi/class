...
assert.match(styles, /\.record-surface\[data-slot="card"\][\s\S]*border-color: var\(--glass-content-border\)[\s\S]*outline: none/, 'written records need one stable box-model boundary in every palette')

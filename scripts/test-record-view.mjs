...
assert.match(page, /<TabsList aria-label="记录显示模式"[\s\S]*recordViewItems\.map[\s\S]*<TabsTrigger/, 'record modes must directly compose the shadcn Tabs component family')

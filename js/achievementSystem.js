(() => {
    ...
    const ACHIEVEMENTS = [
        ...
        { id: 'qcoin-treasury', group: 'coin', title: '金库扩建', description: 'Q币余额达到 6000。', icon: ICONS.coin, condition: (state) => state.stats.balance >= 6000 },
        { id: 'qcoin-tycoon', group: 'coin', title: 'Q币大户', description: 'Q币余额达到 10000。', icon: ICONS.coin, condition: (state) => state.stats.balance >= 10000 },
        { id: 'qcoin-legend', group: 'coin', title: 'Q币传说', description: 'Q币余额达到 20000。', icon: ICONS.coin, condition: (state) => state.stats.balance >= 20000 },
    ...
    function progressForAchievement(achievement, state) {
        ...
        const progressMap = {
            ...
            'qcoin-treasury': () => ratio(state.stats.balance, 6000),
            'qcoin-tycoon': () => ratio(state.stats.balance, 10000),
            'qcoin-legend': () => ratio(state.stats.balance, 20000),
